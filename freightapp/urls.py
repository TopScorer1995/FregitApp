...
urlpatterns = [
    ...
    path('clearance/addactivity', freightapp_view.addactivity, name='addactivity'),
    ...
    path('issues_challenges/', freightapp_view.issues_challenges, name='issues_challenges'),
